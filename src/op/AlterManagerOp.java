		...
		public boolean update(User user)
		{
			boolean altFlag = false;
			 try{
				 ...
				 String sqlstr="update user set name='" +user.getName()+ "',sex='" +user.getSex()+ "',phone='" +user.getPhone()+ "',education='" +user.getEducation()+ "',nation='" +user.getNation()+ "',birthday='" +user.getBirthday()+ "',hiredate='" +user.getHiredate()+ "',address='" +user.getAddress()+ "',nativepla='" +user.getNativepla()+ "',school='" +user.getSchool()+ "'where ide='" +user.getIde()+ "';";
