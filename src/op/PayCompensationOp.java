...
public class PayCompensationOp {
	...
	public boolean update(Compensation compensation)
	{
		boolean altFlag = false;
		 try{
			 ...
			 String sqlstr="update compensation set pay='" +compensation.getPay()+ "',paytime='" +compensation.getPaytime()+"',payment='"+compensation.getPayment()+"' where number='"+compensation.getNumber()+"' and experimenttime='"+compensation.getExperimenttime()+"' and experimentdate='"+compensation.getExperimentdate()+"' and labschool='"+compensation.getLabschool()+"';";
