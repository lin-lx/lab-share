...
import op.SelectLeaVerifyResultOp;
import bean.Application;
import bean.CodeExchange;
import bean.Page;
import bean.User;

public class SelectLeaVerifyResultServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();

	/**
	 * Constructor of the object.
	 */
	public SelectLeaVerifyResultServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			sl = new SelectLeaVerifyResultOp();
			user=new User();
