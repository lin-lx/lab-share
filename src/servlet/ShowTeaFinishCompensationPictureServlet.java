...
import op.ShowTeaFinishCompensationPictureOp;
import bean.CodeExchange;
import bean.Compensation;

public class ShowTeaFinishCompensationPictureServlet extends HttpServlet {
	 ...
	 */
	public ShowTeaFinishCompensationPictureServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ShowTeaFinishCompensationPictureOp l ;
...
String experimentdate=ce.ChineseCoding(request.getParameter("experimentdate"));
				...
				ArrayList<Compensation> compensations=new ArrayList<Compensation>();
				 l = new ShowTeaFinishCompensationPictureOp();
				...
				request.getRequestDispatcher("showteafinishcompensationpicture.jsp").forward(request, response);		
	}
