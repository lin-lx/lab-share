...
public class ShowManNoteFinishPictureServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();
	/**
	 * Constructor of the object.
	 */
	public ShowManNoteFinishPictureServlet() {
		super();
	}
...
String experimentdate=ce.ChineseCoding(request.getParameter("experimentdate"));
				...
				ArrayList<Note> notes=new ArrayList<Note>();
				 l = new ShowManNoteFinishPictureOp();
				 note=new Note();
				...
				request.getRequestDispatcher("showmannotefinishpicture.jsp").forward(request, response);		
	}
