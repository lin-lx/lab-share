...
public class ShowManagesLServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();

	/**
	 * Constructor of the object.
	 */
	public ShowManagesLServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<User> users=new ArrayList<User>();
		 ml = new ShowManagesLOp();
		 user=new User();
		user.setSchool(school);
		p.setTotalcount((ml.getTotalCount(user)));
		 
		
		 try {
		 users = ml.select(user,p.getCurrpageno(), p.getPagesize());
