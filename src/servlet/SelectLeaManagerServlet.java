...
import op.SelectLeaManagerOp;
import bean.CodeExchange;
import bean.Page;
import bean.User;

public class SelectLeaManagerServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();

	/**
	 * Constructor of the object.
	 */
	public SelectLeaManagerServlet() {
		super();
	}
