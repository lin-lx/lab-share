...
import op.SelectManFinishCreditOp;
...
public class SelectManFinishCreditServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();
	/**
	 * Constructor of the object.
	 */
	public SelectManFinishCreditServlet() {
		super();
	}
