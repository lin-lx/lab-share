...
import op.ShowLeaVerifyResultOp;
import bean.Application;
import bean.CodeExchange;
import bean.Page;
import bean.User;

public class ShowLeaVerifyResultServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();

	/**
	 * Constructor of the object.
	 */
	public ShowLeaVerifyResultServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		public void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			sl = new ShowLeaVerifyResultOp();
		    user=new User();
		    user.setSchool(school);
			p.setTotalcount((sl.getTotalCount(user)));
			 
			
			 try {
		    applications=sl.select(user,p.getCurrpageno(), p.getPagesize());
