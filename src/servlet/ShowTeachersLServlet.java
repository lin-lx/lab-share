...
import op.ShowManagesLOp;
import op.ShowTeachersLOp;
import bean.CodeExchange;
import bean.Page;
import bean.User;

public class ShowTeachersLServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();

	/**
	 * Constructor of the object.
	 */
	public ShowTeachersLServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		tl = new ShowTeachersLOp();
		user=new User();
		user.setSchool(school);
		p.setTotalcount((tl.getTotalCount(user))); 
		
		 try {
	    users = tl.select(user,p.getCurrpageno(), p.getPagesize());
