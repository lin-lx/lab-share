...
import op.ShowTeaNoteResultPictureOp;
import bean.CodeExchange;
import bean.Lab;
import bean.Note;

public class ShowTeaNoteResultPictureServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();

	/**
	 * Constructor of the object.
	 */
	public ShowTeaNoteResultPictureServlet() {
		super();
	}
	...
	String experimentdate=ce.ChineseCoding(request.getParameter("experimentdate"));
					...
					ArrayList<Note> notes=new ArrayList<Note>();
					 l = new ShowTeaNoteResultPictureOp();
					 note=new Note();
					...
					request.getRequestDispatcher("showteanoteresultpicture.jsp").forward(request, response);		
		}
