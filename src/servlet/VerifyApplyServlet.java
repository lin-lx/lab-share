...
public class VerifyApplyServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();
	/**
	 * Constructor of the object.
	 */
	public VerifyApplyServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		p.setTotalcount((v.getTotalCount(user)));
		 try {
		 applications =v.select(user,p.getCurrpageno(), p.getPagesize());
