...
import op.AlterLeaderButtonOp;
import bean.CodeExchange;
import bean.User;

public class AlterLeaderButtonServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();
	/**
	 * Constructor of the object.
	 */
	public AlterLeaderButtonServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		al = new AlterLeaderButtonOp();
		ResultSet rs = al.ck(user);


			try {
				if (rs.next()) {
					request.getRequestDispatcher("alterleader.jsp?&username=" + rs.getString(1)
