...
import op.AdministratorShowLabsOp;
import op.ShowTeaLabOp;
import bean.Lab;
import bean.Page;

public class AdministratorShowLabsServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AdministratorShowLabsServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(currpageno==null||"".equals(currpageno)) {
			...
			p.setCurrpageno(Integer.parseInt(currpageno.trim()));
				...
				a = new AdministratorShowLabsOp();
				 p.setTotalcount((a.getTotalCount()));
				 try {
				 labs = a.quire(p.getCurrpageno(), p.getPagesize());
				 } catch (Exception e) {
