...
import op.ShowTeaFinishCompensationOp;
import bean.CodeExchange;
import bean.Compensation;
import bean.Page;
import bean.User;

public class ShowTeaFinishCompensationServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();

	/**
	 * Constructor of the object.
	 */
	public ShowTeaFinishCompensationServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		public void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			ShowTeaFinishCompensationOp st ;
			...
			st = new ShowTeaFinishCompensationOp();
			 user=new User(); 
