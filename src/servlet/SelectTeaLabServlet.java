...
public class SelectTeaLabServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public SelectTeaLabServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			st = new SelectTeaLabOp();
			p.setTotalcount((st.getTotalCount(sql)));
			labs=st.select(sql,p.getCurrpageno(), p.getPagesize());
		} catch (Exception e) {
