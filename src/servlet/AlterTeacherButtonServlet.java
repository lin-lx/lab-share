...
import op.AlterTeacherButtonOp;
import bean.CodeExchange;
import bean.User;

public class AlterTeacherButtonServlet extends HttpServlet {
	CodeExchange ce = new CodeExchange();
	/**
	 * Constructor of the object.
	 */
	public AlterTeacherButtonServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		at = new AlterTeacherButtonOp();
		ResultSet rs =at.ck(user);


			try {
				if (rs.next()) {
					request.getRequestDispatcher("alterteacher.jsp?&username=" + rs.getString(1)
