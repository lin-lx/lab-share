...
.table-a table td{border-left:0;border-top:1px solid skyblue;height:40px}
  ...
  <div id="top">
 当前位置：<a href="ShowRemindServlet"style="text-decoration:none;color:white;">首页公告管理</a> > 添加公告管理 
  </div>
   ...
   <tr><td id="myfont1" style="background:url(images/a.jpg);height:30;">添加公告</td></tr> 
    </table>
  <form  action="RemindServlet" method="post" onSubmit="return validate(this)">
<table border="0">
<tr>
 <td>公告内容:</td> 
  <td><textarea rows="5" cols="50" name="content" style="border: skyblue 1px solid;"></textarea></td>
  </tr>
    	<tr> <td colspan="2" align="center">
    	 <input id="mybutton" type="submit"  name="btnAdd" value="发布">
    	 <input id="mybutton"  type="reset" value="重置" onclick="resetFun()"></td>
