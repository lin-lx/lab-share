...
.table-a table td{border-left:0;border-top:1px solid skyblue;height:40px}
  ...
  <div id="top">
 当前位置：<a href="ShowTeaFinishCompensationServlet?username=<%=session.getAttribute("username")%>" style="text-decoration:none;color:white;">我的赔偿记录</a> > 我的赔偿图片
...
<td><img alt="" src="uploadphotos/<%=compensation.getPicture()%>" style="width:500px" align="top"></td><td><img alt="" src="uploadphotos/<%=compensation.getPicture1()%>" style="width:500px" align="top"></td>
</tr>

 <%}

} %> 
<tr><td align="center" colspan="2"><input type="button" value="返回" id="mybutton" onclick="location.href='ShowTeaFinishCompensationServlet?username=<%=session.getAttribute("username")%>'"></td></tr>
</table>
</center>
   </div>
   </div>
