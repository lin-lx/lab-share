...
.table-a table td{border-left:0;border-top:1px solid skyblue;height:40px}
 ...
 <a href="index.jsp" style="text-decoration:none;color:white;"><img src="sysimages/relogin.png" style="width:20px;height:20px">退出登录</a>
  ...
  <div id="top">
	当前位置：<a href="ShowManFinishNoteServlet?school=<%=session.getAttribute("school")%>"style="text-decoration:none;color:white;">我的检查记录</a> > 检查图片
  </div>
...
<tr><td align="center" colspan="2"><input type="button" value="返回" id="mybutton" onclick="location.href='ShowManFinishNoteServlet?school=<%=session.getAttribute("school")%>'"></td></tr>
</table>
</center>
   </div>
   </div>
