...
<a href="index.jsp" style="text-decoration:none;color:white;"><img src="sysimages/relogin.png" style="width:20px;height:20px">退出登录</a>
  ...
  <div id="top">
  当前位置：<a href="ShowTeaLabServlet" style="text-decoration:none;color:white;">申请实验室</a> > 实验室图片
  </div>
...
<td><img alt="" src="uploadphotos/<%=lab.getPicture() %>" style="width:500px" align="top"></td><td><img alt="" src="uploadphotos/<%=lab.getPicture1() %>" style="width:500px" align="top"></td>
</tr>

 <%}

} %> 
 <tr><td align="center" colspan="2"><input type="button" value="返回" id="mybutton" onclick="location.href='ShowTeaLabServlet'"></td></tr>
