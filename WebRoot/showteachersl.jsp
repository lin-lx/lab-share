...
.table-a table td{border-left:0;border-top:1px solid skyblue;height:40px}
 ...
 <a href="index.jsp" style="text-decoration:none;color:white;"><img src="sysimages/relogin.png" style="width:20px;height:20px">退出登录</a>
  ...
  当前位置：教师信息管理
   ...
   <center>
   <form class="table-c" action="SelectLeaTeacherServlet?school=<%=session.getAttribute("school")%>" method="post">
  ...
  <input type="submit" id="mybutton"  value="查询"> <input type="reset" id="mybutton" value="重置" onclick="resetFun()"></td></tr>
   ...
   <tr style="font-weight: bold;">
       <td colspan="12" id="myfont1" style="background:url(images/a.jpg);height:30;">教师信息</td></tr>
       <tr style="font-weight: bold;">
   ...
   <tr><td align="center"><%=user.getName()%></td>
       ...
       <td align="center"><a href="DeleteTeaServlet?ide=<%=user.getIde()%>&&school=<%=session.getAttribute("school")%>"style="text-decoration:none;color:red;"  onclick="return confirm('您确定要注销此教师信息吗？');"><img src="sysimages/logout.png" style="width:20px;height:20px">注销账号</a></td>
       </tr>
       <%
	             }
	         } %>
