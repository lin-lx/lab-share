...
<a href="leafirst.jsp" style="text-decoration:none;color:white;"><img src="sysimages/first.png" style="width:20px;height:20px">首页</a>
  ...
  <div id="top">
当前位置：<a href="ShowLeaderServlet?username=<%=session.getAttribute("username")%>"style="text-decoration:none;color:white;">我的信息管理</a> > 修改我的信息
  </div>
   ...
   <tr><td id="myfont1" style="background:url(images/a.jpg);height:30;">修改信息</td></tr>
    ...
    <form action="AlterLeaderServlet" method="post" onSubmit="return validBirthday(this)">
    <table border="0">
    <tr>
  <td>姓名:</td>
