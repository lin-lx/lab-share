...
<a href="index.jsp" style="text-decoration:none;color:white;"><img src="sysimages/relogin.png" style="width:20px;height:20px">退出登录</a>
  ...
  <div id="top">
   ...
   <center>
   <form class="table-c" action="SelectTeaLabServlet" method="post">
       ...
       <td align="center" colspan="3">操作</td>
			...
			if(labs!=null){
	          	for(int i=0;i<labs.size();i++)
	         	 {
	            	 ...
	            	 <td align="center">
	            	 <a href="ShowTeaLabPictureServlet?number=<%=lab.getNumber()%>&&labschool=<%=lab.getLabschool()%>" style="text-decoration:none;color:black;"><img src="sysimages/photos.png" style="width:20px;height:20px"></a>
	            	 </td>
	            	
	            	<td align="center">
	            	 	<a href="ShowCommentToAllTeaServlet?number=<%=lab.getNumber()%>&&labschool=<%=lab.getLabschool()%>"style="text-decoration:none;color:black;"><img src="sysimages/tosee.png" style="width:15px;height:15px">查看评论</a>
	            	 </td>	            	
	            	
	            	 <td align="center">
	            	 	<a href="ApplyLabServletOne?number=<%=lab.getNumber()%>&&username=<%=session.getAttribute("username")%>&&labschool=<%=lab.getLabschool()%>"style="text-decoration:none;color:black;"><img src="sysimages/apply.png" style="width:20px;height:20px">申请</a>
	            	 </td>
		...
		<%-- 	[<button style="border:0;background-color: ;"  onclick="javascript:to_page(${Page.currpageno-1})">前一页</button>] --%>
			[<a href="ShowTeaLabServlet?page=${Page.currpageno-1}" style="text-decoration:none">前一页</a>]
 ...
 [<a href="ShowTeaLabServlet?page=${Page.currpageno+1}" style="text-decoration:none">后一页</a>]
