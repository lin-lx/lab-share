...
.table-a table td{border-left:0;border-top:1px solid skyblue;height:40px}
 ...
 <a href="index.jsp" style="text-decoration:none;color:white;"><img src="sysimages/relogin.png" style="width:20px;height:20px">退出登录</a>
  ...
  当前位置：<a href="ShowTeaLabServlet" style="text-decoration:none;color:white;">申请实验室</a> > 实验室评论  > 实验室评论图片
...
<td><img alt="" src="uploadphotos/<%=comment.getPicture()%>" style="width:500px" align="top"></td><td><img alt="" src="uploadphotos/<%=comment.getPicture1()%>" style="width:500px" align="top"></td>
</tr>
<tr><td><input type="hidden" value=<%=comment.getNumber() %>></td><td><input type="hidden" value=<%=comment.getLabschool() %>></td></tr>
<tr><td align="center" colspan="2"><input type="button" value="返回" id="mybutton" onclick="location.href='ShowCommentToAllTeaServlet?number=<%=comment.getNumber()%>&&labschool=<%=comment.getLabschool()%>'"></td></tr>
