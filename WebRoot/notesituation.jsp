...
.table-a table td{border-left:0;border-top:1px solid skyblue;height:40px}
 ...
 <a href="index.jsp" style="text-decoration:none;color:white;"><img src="sysimages/relogin.png" style="width:20px;height:20px">退出登录</a>
  ...
  <div id="top">
  当前位置：<a href="MonitorServlet?school=<%=session.getAttribute("school")%>"style="text-decoration:none;color:white;">记录实验室使用情况</a> > 填写记录表
  ...
  <form action="NoteResultServlet?school=<%=session.getAttribute("school")%>" method="post" onSubmit="return validate(this)" enctype="multipart/form-data">
  <table>
  ...
  <tr>
			...
			<td><input type="text" name="experimentdate"  id="myinput" value="<%=request.getParameter("date")%>" readonly="true" style="color:gray"></td>
			</tr>
			<tr>
				
				<td  align="center">实验室类型:</td>
				<td><input  type="text" name="type"  id="myinput" value="<%=request.getParameter("type")%>" readonly="true" style="color:gray"></td>
			...
			<tr>
				...
				<td><input  type="text" name="notephone"  id="myinput" value="<%=request.getParameter("notephone")%>" readonly="true" style="color:gray"></td>
			</tr>
			
			<tr>
				<td  align="center">是否违约:</td>
				<td>
				<input type="radio" name="treaty" value="否" checked="checked">否
				<input type="radio" name="treaty" value="是">是</td>	
						
				<td  align="center">卫生情况:</td>
				<td><input type="radio" name="environment" value="良好" checked="checked">良好
				<input type="radio" name="environment" value="一般">一般
				<input type="radio" name="environment" value="差">差</td>			
			</tr>
			
			<tr><td  align="center">破损或丢失:</td>
				<td><input type="radio" name="damage" value="否" checked="checked" >否
				<input type="radio" name="damage" value="是">是	
				<td  align="center">需要赔偿:</td>
				<td><input type="radio" name="compensation" value="否" checked="checked">否
				<input type="radio" name="compensation" value="是">是</td>		
				</tr>
			
			<tr>
			<td align="center">破损或丢失说明:</td>
			    <td><input type="text" name="damagedescribe" id="myinput" id="myinput" style="height:50px;"></td>
			<td  align="center">备注:</td>
			    <td><input type="text" name="detail" id="myinput" id="myinput" style="height:50px;"></td>
			...
			<tr><td><input type="hidden" name="experimentdate" id="myinput" value="<%=request.getParameter("date")%>"></td></tr>
