...
.table-a table td{border-left:0;border-top:1px solid skyblue;height:40px}
 ...
 <a href="index.jsp" style="text-decoration:none;color:white;"><img src="sysimages/relogin.png" style="width:20px;height:20px">退出登录</a>
  ...
  <div id="top">
	当前位置：<a href="ShowLabServlet?school=<%=session.getAttribute("school")%>" style="text-decoration:none;color:white;">实验室信息管理</a> > 实验室图片
  </div>
...
<td><img alt="" src="uploadphotos/<%=lab.getPicture()%>" style="width:430px" align="top"></td><td><img alt="" src="uploadphotos/<%=lab.getPicture1()%>" style="width:430px" align="top"></td>
</tr>

 <%}

} %> 
<tr><td align="center" colspan="2"><input type="button" value="返回" id="mybutton" onclick="location.href='ShowLabServlet?school=<%=session.getAttribute("school")%>'"></td></tr>
</table>
</center>
   </div>
   </div>
