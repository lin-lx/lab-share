...
.table-a table td{border-left:0;border-top:1px solid skyblue;height:40px}
 ...
 <a href="index.jsp" style="text-decoration:none;color:white;"><img src="sysimages/relogin.png" style="width:20px;height:20px">退出登录</a>
  ...
  <a href="teafirst.jsp" style="text-decoration:none;color:white;"> <img src="sysimages/reflash.png" style="width:20px;height:20px">刷新</a>
  </div>
  <div id="top">
  当前位置：首页
  ...
  <%int paysize=(Integer)session.getAttribute("size");
  if(paysize>0){
  
  %>
  
 <script> alert("亲爱的用户，欢迎回来!您还有赔偿未支付，请尽快支付，否则不能申请实验室!")</script>
 <% 
  }
   %>
